...
<div class=cat1>
    <img src="<?= URL ?>assets/images/article/developement.svg" alt="img intro dev">
</div>
...
<div class="cat2">
    ...
    <div class="content_proj">
        ...
        <div class="text_proj_dev">
            ...
            </p>L'utilisateur a un profil qu'il peut choisir de révéler lors de sa conversation, et ainsi créer de nouvelles relations amicales ou plus.</p>
        </div>
    </div>
    ...
    <div class="images_proj_dev">
        ...
        <img src="<?= URL ?>assets/images/sendr/sendr4.png" alt="sendr img">
    </div>
</div>
...
<div class="cat2">
    ...
    <div class="content_proj">
        ...
        <div class="text_proj_dev">
            ...
            <p>On peut désormais retrouver ce travail sur  <a href="http://www.serviceprestige.com/"> ce lien</a></p>
        </div>
    </div>

    <div class="images_proj">
        <img src="<?= URL ?>assets/images/service/Home.png" alt="maquette service prestige">
